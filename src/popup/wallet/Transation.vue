          ...
          <el-scrollbar>
            <div class="transation-root">
              ...
              <div class="transation-success">
                ...
                <div class="transation-type">{{$t('wallet.transferSuccess')}}</div>
                <div
                  :class="['transation-count',trx.receiver == account.name ? 'transation-count-blue' : 'transation-count-red']"
                >{{trx.receiver == account.name ? '+' + trx.quantity : '-' + trx.quantity }}</div>
              </div>
              ...
              <div class="item-group">
                <div class="item">
                  ...
                  <div class="item-value transation-number-value">{{trx.trx_id}}</div>
                </div>
                <div class="item">
                ...
                <div class="item">
                  ...
                  <div class="item-search">
                    <div @click="handlerQuery('https://bloks.io/transaction/')">
                      <img alt src="../../assets/images/bloks.png">
                      <span>bloks</span>
                    </div>
                    <div @click="handlerQuery('https://eosflare.io/tx/')">
                      <img alt src="../../assets/images/eosflare.png">
                      <span>eosflare</span>
                    </div>
                  </div>
                  <div class="item-search">
                    <div @click="handlerQuery('https://www.eosx.io/tx/')">
                      <img alt src="../../assets/images/eosx.png">
                      <span>eosx</span>
                    </div>
                    <div @click="handlerQuery('https://eos.eosq.eosnation.io/tx/')">
                      <img alt src="../../assets/images/eosq.png">
                      <span>eosq</span>
                    </div>
                  </div>
                </div>

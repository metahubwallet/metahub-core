...
export default {
  public: { // 公共部分
    ...
    viewUserProtocolsContent: '感谢您选择 Metahub 服务。《 Metahub 服务协议》（以下简称“本协议”）由Metahub和您（以下简称“用户”）签订，本协议在您与Metahub之间具有合同上的法律效力。在本协议中：（1）“我们”和“我们”指代Metahub，“我们的”应据此解释；及（2）“您”指代用户，“您的”应据此解释。您和Metahub单独称为“一方”，合称为“双方”。Metahub在此特别提醒您在使用我们的 Metahub 应用之前，请认真阅读本协议及后文提及的相关协议，尤其是本协议中“免责及责任限制”等以加粗形式体现的条款，确保您充分理解本协议中各条款，并自主考虑风险。',
    voteMax: '最多只能投30个节点',
    noAccount: '无账号',
    noImport: '您没有导入任何账号',
    start: '开始使用',
    setMnemonic: '设置预留信息',
    setMnemonicTip: '为了避免钓鱼网站，请设置一些预留信息，如座右铭等。该安全语将会在用户解锁及授权时出现，若不出现或内容不匹配，说明用户登录的可能是钓鱼网站。',
    import: '导入',
    importBackup: '导入备份',
  ...
  resource: {
    ...
    freeCPU: '免费CPU',
    tradeREX: '买卖REX',
    rechargeTab1: '0.1 EOS 100 ms 大约转账350次',
    rechargeTab2: '0.5 EOS 500 ms 大约转账1750次',
    rechargeTab3: '1.0 EOS 1000 ms 大约转账3500次',
    rechargeTab4: '3.0 EOS 3000 ms 大约转账1万次',
  ...
  setting: {
    ...
    securityNotice: '为了您的资产安全，建议使用 Active 权限导入钱包日常使用。并妥善保管 Owner 权限对应的私钥。',
    add: '添加',
    remove: '移除',
    modify: '修改',
    removeTip: '确定删除该公钥?',
  ...
  auth: {
    ...
    whitelistTip: '您可以将此操作列入白名单，下次就不必在此确定交易，勾选属性旁边单选框意味着您不限制此项值内容，否则会严格限制。'
  },
  // 应用
  application: {
    myDApps: '我的DApps',

...
export default {
  public: { // common part
    ...
    setMnemonicTip: 'In order to avoid phishing websites, please set some reservation information, such as motto. The security language will appear when the user unlocks and authorizes. If it does not appear or the content does not match, the user may log in to the phishing website.',
    import: 'Import',
  ...
  resource: {
    ...
    freeCPU: 'Free CPU',
    tradeREX: 'Trade REX',
    rechargeTab1: '0.1 EOS 100 ms 350 transfers estimated',
    rechargeTab2: '0.5 EOS 500 ms 1750 transfers estimated',
    rechargeTab3: '1.0 EOS 1000 ms 3500 transfers estimated',
    rechargeTab4: '3.0 EOS 3000 ms 1000 transfers estimated',
  ...
  setting: {
    ...
    activeNotice: 'Active : By default, all transations can be done except to change the Owner.',
    securityNotice: 'For the scurity of your assets, it is recommended to use the Active Permissions to import the wallet. And keep the Owner Permissions in a safe place.',
    add: 'Add',
    remove: 'Remove',
    modify: 'Modify',
    ...
    changeNoticeOne: 'If you are replacing the currently used public key, you need to re-import the wallet with the private key to use it.',
    changeNoticeTwo: 'Please comfirm that the private key corresponding to the public key is properly kept.',
    submit: 'Submit',
    ...
    generateTipTwo: 'It is recommended to copy or print the private key and place it in a safe place.',
    ...
    encryptPasswordTip: 'Encrypt password should be greater than 8 digits and include letters and numbers',
    whitelist: 'Whitelist',
    ...
    alreadyExistAccount: 'This network has an account import, please delete the account before operating',
  },
  ...
  password: {
    ...
    unlockTip: 'When Metahub asks for a password, the icon of the plugin will turn red. Please pay attention!'
  },
  ...
  auth: {
    ...
    whitelistTip: 'You can whitelist these actions, and you do not have to confirm these transactions. You can confirm what you need to whitelist by checking the checkbox.'
  },
  // 应用
  application: {
    myDApps: 'My Dapps',
  ...
  error: {
    firstNeedEOS: 'This ETH payment address is used for the first time, you need to transfer more than 0.1 EOS to activate it.',

...
//解密方法
export function decrypt(word, seed = key) {
...
//加密方法
export function encrypt(word, seed = key) {
  seed = CryptoJS.enc.Utf8.parse(seed);
...
export function password1(word) {
  return sha1(sha1('metahub-' + word) + '#c22Dc1B6');
}

export function password2(word) {
